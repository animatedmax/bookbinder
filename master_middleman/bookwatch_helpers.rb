require 'bookwatch/code_example_reader'
require 'bookwatch/ingest/cloner_factory'
require 'bookwatch/ingest/git_accessor'
require 'bookwatch/local_filesystem_accessor'
require 'date'
...
::Middleman::Extensions.register(:bookwatch, Bookwatch::Helpers)
